...
# plt.imshow(data[31,:,:,0],cmap = 'gray',interpolation = 'nearest')
# plt.savefig("figures/result_31.png")

label_SDM, label_abs_SDM = get_SDMmap(label[31,:,:,0])
# SDMmap_vec_gradient = get_limited_circle_gradient_SDMmap(label[31,:,:,0])
...
# qk = plt.quiverkey(Q, 1, 1, 2, r'$2 \frac{m}{s}$', labelpos='E',
                    # coordinates='figure')
plt.savefig("figures/result_31_vec.png")
