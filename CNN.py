...
model_n = '1_20_limitedCircle'
# 

# with tf.device('/gpu:0'):


patches = np.load(data_p + '/train_data/patches_SDM_train_1_20_limitedCircle.npy').astype(np.float32)
vecs = np.load(data_p + '/train_data/vecs_SDM_train_1_20_limitedCircle.npy').astype(np.float32)
